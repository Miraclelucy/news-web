 ...
 * @修改人和其它信息
 */
@WebServlet(name="ValidateCodeServlet", urlPatterns={"/validateCode"},loadOnStartup=1)
...
//			g.drawString(r, i*w/4, h-5);
     ...
     *@修改人和其它信息
     */
    private void createImage2(HttpServletRequest request,
                             HttpServletResponse response) throws IOException {
        response.setContentType("image/jpeg");
